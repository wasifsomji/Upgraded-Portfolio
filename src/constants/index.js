  ...
  const experiences = [
    {
      ...
      points: [
        "Designed and developed a WebSocket-based solution to replace polling in Amazon’s multi-factor authentication (MFA) mobile flow for payment registration, reducing request volume by 88% and saving 128+ million requests annually.",
