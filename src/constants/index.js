  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        ...
        "Designed and implemented 150+ unit and integration tests across 8+ Go microservices, significantly improving test coverage and reducing regression bugs in production releases.",
