  ...
  const experiences = [
    {
      ...
      points: [
        ...
        "Backfilled 520M+ idempotency keys to centralize the source of truth for sale transactions, eliminating 400M+ annual dual writes and preventing redundant record creation across microservices."
      ]
    },
    {
